...
def C_q_energy_conserving(t, q1, q2, v1, v2, v3, params):
    ...
    """
    C_q1 = v1 * (v1**2 + v2**2 + v3**2) / 2
    C_q2 = v2 * (v1**2 + v2**2 + v3**2) / 2
...
def C_p_energy_conserving(t, q1, q2, v1, v2, v3,
    ...
    C_p1 = (v1**2 + v2**2 + v3**2) * (e/m) * (E1 + v2 * B3 - v3 * B2) / 2
    C_p2 = (v1**2 + v2**2 + v3**2) * (e/m) * (E2 + v3 * B1 - v1 * B3) / 2
    C_p3 = (v1**2 + v2**2 + v3**2) * (e/m) * (E3 + v1 * B2 - v2 * B1) / 2
